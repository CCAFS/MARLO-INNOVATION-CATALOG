      ...
      innovations: [
        {
          ...
          country: "Senegal",
          title:
            "The Community of Practices of Institutions creates an environment",
          summary:
            "Institutions collaborate to co-create and disseminate climate adaptation advisories for agro-pastoralists.",
          key_metrics: {
            geoscope: "Senegal",
          ...
          expected_outcomes:
            "Local radio stations and farmer organizations increase advisory coverage reaching 80k households.",
          intended_beneficiaries:
            "Smallholder farmers, rural women groups, and youth cooperatives.",
          comments: [
            {
              author: "Jhon Doe",
              date: "22 Jul 2024",
        ...
        },
        {
          ...
          summary:
            "A mobile app delivers real-time irrigation guidance using weather and soil data.",
          key_metrics: {
            geoscope: "Ghana",
        ...
        },
        {
          ...
          summary:
            "New seed lines tested for high yield under low rainfall conditions.",
          key_metrics: {
            geoscope: "Kenya",
        ...
        },
        {
          ...
          summary:
            "Local communities trained to interpret meteorological data and advise farmers.",
          key_metrics: {
            geoscope: "Ethiopia",
          ...
          expected_outcomes:
            "Improved planting decisions in 50 rural districts.",
        ...
        },
        {
          ...
          summary:
            "Integration of Faidherbia albida trees into farming systems.",
          key_metrics: {
            geoscope: "Mali",
          ...
          expected_outcomes:
            "Soil fertility improvement and 10% yield increase.",
        ...
        },
        {
          ...
          summary:
            "Weather-index insurance products tailored for small farmers.",
          key_metrics: {
            geoscope: "Nigeria",
      ...
      innovations: [
        {
          ...
          summary:
            "Pilot units help reduce post-harvest losses for vegetables.",
          comments: [],
        },
        {
          id: "inv-008",
