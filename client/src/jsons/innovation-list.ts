...
export const innovationCatalog : InnovationDetail[] = [
    {
      ...
      "narrative": "A cutting-edge water purification system that uses nanotechnology to remove contaminants and provide clean drinking water in remote areas.",
      "year": 2023,
      "phase": {
        "id": 3,
        "name": "Pilot"
      ...
      "organizations": [
        { "id": 1, "name": "Global Water Initiative" }
      ],
      "externalPartners": [
        {
          "id": 1,
