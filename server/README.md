...
- 🧪 Unit Testing: Jest as the main testing framework
  - 📊 Coverage: Branches 70 · Functions 70 · Lines 50 · Statements 50
- 💅 Prettier: Automatic and consistent code formatting
- 🪵 Logging: `AppLoggerService` emits structured JSON for every request and the global exception filter captures all errors automatically
